...
const bulhhall = new google.maps.Marker({
  ...
  const bulhinfowindow = new google.maps.InfoWindow({
...
const willyinfowindow = new google.maps.InfoWindow({
    content: "This Willy , boys upperclassmen dorms",
  });
 
  willy.addListener("click", () => {
    willyinfowindow.open({
      anchor: Willy,
      map,
      shouldFocus: false,
     });
...
const feildhouseinfowindow = new google.maps.InfoWindow({
...
const cafeinfowindow = new google.maps.InfoWindow({
